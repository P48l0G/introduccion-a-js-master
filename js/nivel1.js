...
console.log('Su edad actual es ' + calcularEdadUsuario(anioActual, anioNacimiento) + ' años.');


function calcularSalarioMensual(salarioAnual){
    return(salarioAnual / 12);
}
const salarioAnual = Number(prompt('¿Cuál es su salario anual?', 3600000));

function calcularSalarioAnual(salarioMensual){
    return(salarioMensual * 12);
}
const salarioMensual = Number(prompt('¿Cuál es su salario mensual?'));
...
const salarioSemanal = Number(prompt('¿Cuál es su salario semanal?'));

function calcularSalarioHora(salarioDiario){
    return(salarioDiario / 8);
}
const salarioDiario = Number(prompt('¿Cuál es su salario diario?'));
...
console.log('Su salario diario es de $' + calcularSalarioDiario(salarioSemanal));
console.log('Su salario por hora es de $' + calcularSalarioHora(salarioDiario));
*/
...
if(operador === '+'){
    console.log(numero1 + ' + ' + numero2 + ' = ' + sumar(numero1, numero2));
    }else{
        console.log(numero1 + ' - ' + numero2 + ' = ' + restar(numero1, numero2));
    }
*/
