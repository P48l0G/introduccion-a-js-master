...
/*
    ...
    A estos elementos los llamamos "tags". Cada elemento de la página tiene un tag que abre y 
    otro que cierra. (NOTA: Algunos tags, como <img />, no necesitan ser cerrados con otro tag.)
...
// RECORDAR:
// Para seleccionar el elemento con la clase "twitter" usamos: document.querySelector('.twitter'),
// Para las clases se usa el punto (para class="twitter" es .twitter, para class="website" es .website, etc.)

// EL ejemplo previo quedaría asi:
// const nuestroTwitter = document.querySelector('.twitter');
// nuestroTwitter.textContent = '@ButenkoMe';
// console.log(nuestroTwitter.textContent);
...
nuestroSubtitulo.style.color = 'green';
nuestroSubtitulo.style.backgroundColor = 'lightYellow';
